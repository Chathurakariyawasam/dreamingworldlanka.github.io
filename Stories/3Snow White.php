...
<link rel="icon" type="image/gif/png" href="3_3.jpg"> 



<style>
div.background {
  background: url(3_1.jpg) repeat;
...
<audio controls autoplay loop>
  ...
  <source src="3_1.mp3" type="audio/mpeg" >
...
<p>The Queen flew into a jealous rage and ordered her huntsman to take Snow White into the woods to be killed.  She demanded that the huntsman return with Snow White's heart as proof. 
...
<br> <br>
Not knowing that this new queen was indeed her stepdaughter, she arrived at the wedding, and her heart filled with the deepest of dread when she realized the truth - the evil queen was banished from the land forever and the prince and Snow White lived happily ever after.</p>

<br> <br> <h1>  The End..... </h1>
<br> 
		<br> <br> <center> 
			<a href="../Story pdf/3.pdf" download>
			<img src="../123.png" alt="pdf download">
			</a>
			
		</center>
		<a href="2Beauty And The Beast.php" class="previous">&laquo; Previous</a>
<a href="4Rapunzel.php" class="next">Next &raquo;</a>
